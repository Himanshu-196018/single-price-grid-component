...
- Solution URL: [Solution](https://github.com/Himanshu-196018/single-price-grid-component)
- Live Site URL: [Demo/site](https://himanshu-196018.github.io/single-price-grid-component/)
...
This project helped me to improve my basic styling and palcement of different elements by building a Single price grid component.
